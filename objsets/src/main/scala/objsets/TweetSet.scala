...
class Empty extends TweetSet {
  ...
  def mostRetweetedAcc: Tweet = null
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweetedAcc: Tweet = {
    val rightMostRetweet = right.mostRetweetedAcc
    val leftMostRetweet = left.mostRetweetedAcc
    if (elem.retweets >= leftMostRetweet.retweets) {
      if (elem.retweets >= rightMostRetweet.retweets) elem
      else rightMostRetweet
    } else {
      if (leftMostRetweet.retweets >= rightMostRetweet.retweets) leftMostRetweet
      else rightMostRetweet
    }
  }
